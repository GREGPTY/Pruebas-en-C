...
int main()
{
    ...
    char gridu[10][10],griduv[10][10],gridc[10][10],gridcv[10][10],orin[2],tempstr[10],str[20]="Battleships V1.0",str1[50]="Written By: GreG TorreS",ch;
   for(i=0;i<10;i++)
    {
        printf("\n");
    }
