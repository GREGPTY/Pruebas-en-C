...
Battleships
Version 3.0
Written by:  Genesis Rodriguez, Greg Torres
*/
#include<stdio.h>
#include<strings.h>
#include<conio.h>
...
int main()
{
    ...
    char gridu[10][10],griduv[10][10],gridc[10][10],gridcv[10][10],orin[2],tempstr[10],str[20]="Battleships V3.0",str1[50]="Written By: Genesis and Greg\n",ch;
   for(i=0;i<10;i++)
    {
        printf("\n");
    }
